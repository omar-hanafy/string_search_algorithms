...
void main() {
  group('OSA (Optimal String Alignment)', () {
    test('simple transposition', () {
      ...
      expect(
        StringSimilarity.compare('abc', 'acb',
            algorithm: SimilarityAlgorithm.osa),
    ...
    test('restricted transposition', () {
      ...
      // OSA: CA -> AC (1). But "AC" was formed by transposition. "ABC"
      // requires inserting B into "AC".
      ...
      expect(
          StringSimilarity.compare('ca', 'abc',
              algorithm: SimilarityAlgorithm.osa),
          equals(0.0));
      expect(
          StringSimilarity.compare('ca', 'abc',
