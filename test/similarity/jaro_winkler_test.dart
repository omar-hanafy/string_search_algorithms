...
void main() {
  group('Jaro-Winkler', () {
    ...
    test('extension method', () {
      expect(
        'MARTHA'
            .similarityTo('MARHTA', algorithm: SimilarityAlgorithm.jaroWinkler),
        closeTo(0.96, 0.01),
      );
    });
    ...
    test('identical strings', () {
      expect(
          'abc'.similarityTo('abc', algorithm: SimilarityAlgorithm.jaroWinkler),
          equals(1.0));
    });
    ...
    test('prefix boost', () {
      ...
      expect(
        'hello world'.similarityTo('hello warld',
            algorithm: SimilarityAlgorithm.jaroWinkler),
        greaterThan(0.9),
      );
    });
